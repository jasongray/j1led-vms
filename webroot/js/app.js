var App = function () {
    ...
    var handleMainMenu = function () {
        jQuery('.page-sidebar .has-sub > a').click(function (e) {
        	e.preventDefault();
    ...
    var handleLoginForm = function () {
        ...
        jQuery('#forget-btn, #back-btn').click(function (e) {
            e.preventDefault();
        ...
        jQuery('.login-form input').bind('keypress',function (e){
        	if (e.keyCode === 13){
        		jQuery(".login-form").submit();
    		}
		});
...
*/
    ...
    var handleOverlord = function () { 
    	$('a').not($('a.disabled, .disabled a, .has-sub a, .dropdown-toggle, .accordion-toggle, .wysihtml5-toolbar a, .btn-navbar, .tabbable li a, .add-on a, .chzn-container a, .tools a, .bootstrap-timepicker a, .cake-stack-trace a')).click(function(){ overlay();});
    	$('.sub a').click(function(){ overlay();});
		$('form').submit(function(){ overlay();});
    }
	...
	var overlay = function() {
		offset = getViewport();
		$('.loadingdesigner').css('height',offset.h).css('top', offset.t);
    ...
    return {
        ...
        blockUI: function (el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="'+_baseurl+'img/loading.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
