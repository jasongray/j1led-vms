<?php $this->Html->addCrumb(__('Sign Fonts'), array('controller' => 'signFonts', 'action' => 'index'));?>
<?php $this->Html->addCrumb(__('Add Font'));?>
	...
	<div class="span12">
		<div class="portlet box blue">
			<div class="portlet-title">
				<h4><i class="icon-user"></i><?php echo __('Add Font');?></h4>
			</div>
